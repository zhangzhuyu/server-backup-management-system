...
public enum ResultCode {
    ...
    INFO(7001, "Prompt Information"),
    WARNING(7002, "Warning Information"),
    FAILURE(7003, "Faliure Information"),
    ERROR(7004, "Error Information"),
    FATAL(7005, "Fatal Information"),
    ...
    public static int parseInt(ResultCode code) {
        return code.value;
    }
}
