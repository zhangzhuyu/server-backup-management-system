...
public class KibanaHttpClient {
    ...
    private static final Logger log = LoggerFactory.getLogger(KibanaHttpClient.class);
    ...
    public static String getResponseWithHttpClient(String url, String encode, Map<String, String> content) {
        ...
        try {
            ...
            result = KibanaHttpClient.ConverterStringCode(buffer.toString(), postMethod.getResponseCharSet(), encode);
            return result;
        } catch (Exception e) {
...
//            WebResponse<?> webResponse = taierController.listTenant();
    ...
    public static String doPost(String url, Map<String, String> params) {
         ...
         try {
             ...
             result = buffer.toString();
             result = KibanaHttpClient.ConverterStringCode(buffer.toString(), postMethod.getResponseCharSet(), "utf-8");
             return result;
         } catch (Exception e) {
             throw new RuntimeException(e.getMessage(), e);
         } finally {
...
//            httpPost.setHeader("kbn-version","7.13.4");
     ...
     */
    public static String sendJsonPost(String url, String encoding,String sid,String domain,String kbnVersion,JSONObject jsonObject) throws ParseException, IOException, ClassNotFoundException {
        String body="";
        CloseableHttpResponse response = null;
        try {

        log.info("进入sendJsonPost方法url："+url);
        log.info("进入sendJsonPost方法charset："+encoding);
        if (StringUtils.isEmpty(encoding)){
            encoding = "utf-8";
        }
        /**
