...
Function_Speedtest_Fast() {
    ...
    # 快速测试
    Run_Speedtest "45170"  "China, Beijing CU  "
    Run_Speedtest "27594"  "China, Shanghai CT "
    Run_Speedtest "5530"  "China, Hangzhou CM "
    # 执行完成, 标记FLAG
...
Function_Speedtest_Full() {
    ...
    Run_Speedtest "default" "Speedtest Default"
    # 国内测试 - 联通组
    Run_Speedtest "45170" "China, ZheJiang CU  "
	Run_Speedtest "24447" "China, YangZhou CU  "
    # 国内测试 - 电信组
    Run_Speedtest "27594"  "China, GuangZhou CT "
	Run_Speedtest "17145"  "China, HeFei CT "
    # 国内测试 - 移动组
    Run_Speedtest "5530" "China, ZheJiang CM "
...
Function_BestTrace_Full() {
    ...
    if [ "${LBench_Result_NetworkStat}" = "ipv4only" ] || [ "${LBench_Result_NetworkStat}" = "dualstack" ] || [ "${LBench_Result_NetworkStat}" = "unknown" ]; then
        ...
        Run_BestTrace "218.185.246.1" "${GlobalVar_TracerouteMode}" "30" "South Korea, China CT CN2"
        #Run_BestTrace "13.124.63.251" "${GlobalVar_TracerouteMode}" "30" "South Korea, Amazon AWS"
        # 台湾部分
        Run_BestTrace "202.133.242.1" "${GlobalVar_TracerouteMode}" "30" "China, Taiwan Chief"
        ...
        Run_BestTrace "66.102.252.1" "${GlobalVar_TracerouteMode}" "30" "United States, Los Angeles China CT CN2"
        ...
        Run_BestTrace "5.10.138.1" "${GlobalVar_TracerouteMode}" "30" "German, Frankfurt China CT CN2"
